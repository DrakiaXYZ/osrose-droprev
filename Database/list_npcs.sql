...
INSERT INTO `list_npcs` VALUES (0, '[Village Chief] Cornell', 1001, 1, 12.550, 5096.51, 5256.04, 101,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Junon Order Co-Founder] Francis', 1003, 1, 157.957, 5080.30, 5066.28, 103,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Righteous Crusader] Leonard', 1005, 1, 266.005, 5127.04, 5208.73, 105,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Eccentric Inventor] Spero', 1011, 1, 0.000, 5273.10, 5267.12, 111,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Weapon Seller] Raffle', 1008, 1, 3.008, 5213.73, 5260.83, 108,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Armor Seller] Carrion', 1009, 1, 34.535, 5198.30, 5253.83, 109,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Guide] Lena', 1014, 1, 333.435, 5272.68, 5079.04, 114,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Ferrell Guild Staff] Crow', 1004, 1, 180.500, 5210.44, 5104.79, 104,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Akram Kingdom Minister] Warren', 1002, 1, 181.501, 5132.56, 5078.95, 102,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Cornell''s Grandson] Cheney', 1018, 1, 22.043, 5435.30, 5492.26, 118,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Designer] Keenu', 1010, 1, 238.556, 5319.51, 5151.29, 110,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Ferrell Guild Staff] Ulysses', 1012, 1, 333.435, 5291.10, 5264.22, 112,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Gypsy Merchant] Mina', 1007, 1, 307.514, 5308.01, 5241.04, 107,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Arumic Merchant] Tryteh', 1006, 1, 298.187, 5316.27, 5212.11, 106,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Keenu''s Daughter] Arisa', 1020, 1, 275.985, 5428.17, 5082.68, 120,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Tavern Owner] Sharlin', 1013, 1, 191.421, 5300.45, 5112.64, 113,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Lena''s Sister] Shirley', 1019, 1, 322.406, 5504.69, 5274.08, 119,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 3040, 2, 0.000, 4829.88, 4645.83, 0,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 3041, 2, 0.000, 4832.84, 4645.52, 0,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 1791, 2, 0.000, 4838.05, 4644.56, 0,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 1792, 2, 0.000, 4841.91, 4644.57, 0,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 1793, 2, 0.000, 4845.60, 4644.59, 0,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 1794, 2, 0.000, 4849.58, 4644.48, 0,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 1795, 2, 0.000, 4853.38, 4644.49, 0,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 3042, 2, 0.000, 4835.08, 4645.67, 0,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Clan Manager] Burtland', 1115, 2, 19.295, 5290.60, 5267.60, 215,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Honor Items] Henry', 2001, 2, 134.288, 5290.83, 5235.59, 233,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Honor Weapons] William', 2002, 2, 277.961, 5345.67, 5265.91, 234,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Honor Armors] Theodor', 2003, 2, 254.300, 5345.55, 5230.20, 235,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Valor Materials] Mason', 2011, 2, 179.500, 5342.26, 5113.85, 236,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Akram Ambassador] Adalric', 1108, 2, 155.002, 5463.48, 5168.30, 226,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Premium Shop] Lyon', 1080, 2, 177.998, 5651.50, 5184.78, 1080,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Captain] Peg Leg', 3020, 2, 160.035, 5670.86, 4910.20, 232,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Stranded Resident] Morgan', 1132, 21, 0.000, 5354.81, 5014.18, 154,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Fruit Seller] Magdalena', 1135, 21, 353.933, 5513.39, 5248.06, 157,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Resident] Rudolfo', 1134, 21, 173.415, 5501.85, 5211.11, 156,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Livestock Farmer] Enu', 1133, 21, 24.237, 5496.56, 5248.00, 155,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Smith] Rockwell', 1138, 21, 105.700, 5441.02, 5191.52, 158,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Weapon Merchant] Dune', 1139, 21, 165.112, 5458.63, 5181.31, 159,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Mountain Guide] Shannon', 1052, 21, 0.000, 5472.73, 5070.27, 152,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'Melendino', 1473, 22, 212.618, 5095.21, 5312.66, 16,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Muse Trainer] Media', 1057, 22, 173.933, 5099.13, 5405.39, 59,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Hawker Trainer] Connor', 1058, 22, 328.307, 5110.77, 5432.79, 60,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Dealer Trainer] Titania', 1059, 22, 0.000, 5094.77, 5437.11, 61,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Soldier Trainer] Murphy', 1056, 22, 40.893, 5054.37, 5439.15, 58,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Pumpkin Farmer] Claude', 1060, 22, 95.984, 5126.59, 5280.70, 62,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Boy by the Cart]Huey', 1021, 22, 323.451, 5355.05, 5401.97, 50,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Path Guard] Bert', 1065, 22, 19.965, 5457.67, 5387.48, 63,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Smith] Ronk', 1034, 22, 176.992, 5653.93, 5152.59, 53,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Little Street Vendor] Pony', 1035, 22, 145.465, 5637.80, 5157.90, 54,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Village Chief] Gray', 1038, 22, 90.000, 5627.19, 5172.31, 57,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Ferrell Guild Staff] Seyon', 1036, 22, 23.492, 5632.37, 5194.24, 55,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Old Man] Myad', 1041, 22, 270.000, 5669.22, 5180.15, 56,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Akram Minister] Mairard', 1032, 22, 337.957, 5662.79, 5196.41, 52,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Visitor Guide] Arua''s Fairy', 1030, 22, 123.017, 5699.97, 5119.75, 51,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Ferrell Guild Staff] Peron', 1511, 22, 352.369, 5828.29, 5205.66, 64,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Novice Designer] Cassirin', 1040, 22, 340.035, 5896.42, 5148.75, 140,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Breezy Hills Militia] Mercucio', 1067, 23, 311.684, 5080.09, 5194.14, 165,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Breezy Hills Militia] Rahl', 1070, 23, 24.237, 5469.98, 5507.27, 166,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[El Verloon Tourism Board] Caraan', 1074, 24, 0.000, 5383.02, 4918.30, 167,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Beach Resident] Judith', 1204, 36, 358.499, 5115.68, 5324.15, 308,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Beach Resident] Judith', 1216, 37, 358.499, 5115.68, 5324.15, 308,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Beach Resident] Casey Jean', 1210, 37, 16.102, 5256.56, 5304.59, 326,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Pie Crush] Tony', 1046, 37, 343.898, 5325.37, 5365.62, 93,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Old Fisherman] Sal', 1066, 37, 197.351, 5298.50, 5045.70, 65,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Festival Manager] Lero', 1055, 39, 0.000, 5072.25, 5363.08, 97,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Gentleman Explorer] Toffee Coffington', 1182, 51, 212.618, 5655.85, 5210.83, 282,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Gentleman Explorer] Nicholai Coffington', 1187, 52, 338.662, 6145.36, 5238.13, 287,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Gentleman Explorer] Wilhelm Coffington', 1183, 53, 0.000, 6004.57, 5368.40, 283,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 1271, 61, 12.550, 5630.54, 4429.22, 0,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 1026, 66, 0.000, 5713.31, 4233.27, 0,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 1027, 66, 0.000, 5713.16, 3918.96, 0,0,0,0);
INSERT INTO `list_npcs` VALUES (0, '[Ruins Curator] Hope', 1249, 66, 180.000, 5900.05, 4341.24, 409,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 1024, 66, 0.000, 5868.43, 4225.89, 0,0,0,0);
INSERT INTO `list_npcs` VALUES (0, 'NO NAME FOUND (NPC)', 1025, 66, 0.000, 5867.85, 3940.73, 0,0,0,0);
...
INSERT INTO `list_npcs` VALUES (0, '[Valor Quest Giver] Roen', 1497, 71, 342.011, 5215.88, 5139.86, 447,0,0,0);
